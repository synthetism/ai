...
export class OpenRouter implements IAI {
  ...
  async ask(prompt: string, options?: AskOptions): Promise<AIResponse> {
    try {
      ...
      throw new AIError(
        `OpenRouter ask failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "openrouter",
      );
    }
  }
  ...
  async tools(
    ...
    try {
      ...
      if (error instanceof AIError) throw error;
      throw new AIError(
        `OpenRouter tools failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "openrouter",
      );
    }
  }
  ...
  async chat(
    ...
    try {
      ...
      if (error instanceof AIError) throw error;
      throw new AIError(
        `OpenRouter chat failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "openrouter",
      );
    }
  }
