...
export class Claude implements IAI {
  ...
  async ask(prompt: string, options?: AskOptions): Promise<AIResponse> {
    try {
      ...
      throw new AIError(
        `Claude ask failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "claude",
      );
    }
  }
  ...
  async tools(
    ...
    try {
      ...
      if (error instanceof AIError) throw error;
      throw new AIError(
        `Claude tools failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "claude",
      );
    }
  }
  ...
  async chat(
    ...
    try {
      ...
      if (error instanceof AIError) throw error;
      throw new AIError(
        `Claude chat failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        "claude",
      );
    }
  }
